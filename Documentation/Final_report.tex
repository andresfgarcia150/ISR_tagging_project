...
It is enough to type \texttt{make} to install it}. Once installed, go to
the \texttt{examples} folder located at the Pythia directory \footnote{If 
\texttt{examples} is not exactly there, it may be in \texttt{share/Pythia8}}.
...
\noindent and these others at the end:

\lstinputlisting[language=make]{Make_second_part}

After doing so, the code is compiled by typing:
