...
Each of them is included inside a different folder with other files that contain
...
Some important parameters of each program are defined at the beginning of the
corresponding code (lines 46 - 57) in the form of global variables. These parameters 
...
files and folders are presented. A few rules should be taken into account when checking the
...
All the technical details of the tagging program can be found in the comments of 
the code.
