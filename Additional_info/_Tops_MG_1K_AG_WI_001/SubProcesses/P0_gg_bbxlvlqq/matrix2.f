...
C     
C     Process: g g > t t~ > b b~ e+ ve d u~ WEIGHTED=10
C     Process: g g > t t~ > b b~ e+ ve s c~ WEIGHTED=10
C     Process: g g > t t~ > b b~ mu+ vm d u~ WEIGHTED=10
C     Process: g g > t t~ > b b~ mu+ vm s c~ WEIGHTED=10
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_3(W(1,5),W(1,6),GC_100,MDL_MW,MDL_WW,W(1,10))
      CALL FFV2_3(W(1,8),W(1,7),GC_100,MDL_MW,MDL_WW,W(1,6))
      CALL FFV2_1(W(1,3),W(1,10),GC_100,MDL_MT,MDL_WT,W(1,8))
      CALL FFV2_2(W(1,4),W(1,6),GC_100,MDL_MT,MDL_WT,W(1,10))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,10),W(1,8),W(1,9),GC_11,AMP(1))
      CALL FFV1_1(W(1,8),W(1,1),GC_11,MDL_MT,MDL_WT,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,10),W(1,9),W(1,2),GC_11,AMP(2))
      CALL FFV1_2(W(1,10),W(1,1),GC_11,MDL_MT,MDL_WT,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,9),W(1,8),W(1,2),GC_11,AMP(3))
