...
C     
C     Process: g g > t t~ > b b~ e- ve~ u d~ WEIGHTED=10
C     Process: g g > t t~ > b b~ e- ve~ c s~ WEIGHTED=10
C     Process: g g > t t~ > b b~ mu- vm~ u d~ WEIGHTED=10
C     Process: g g > t t~ > b b~ mu- vm~ c s~ WEIGHTED=10
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! g g > b b~ e- ve~ u d~
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! g g > b b~ e+ ve d u~
      ENDIF
      RETURN
      END
