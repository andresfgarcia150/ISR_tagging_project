...
To use Delphes, for instance, it is enough to have installed it and use
the existent cards.
...
\texttt{./DelphesSTDHEP cards/delphes\_card\_CMS.tcl delphes\_output.root output\_pythia.root}
...
\bibliography{My_Bibliography_report}\addcontentsline{toc}{chapter}{Bibliografía}
