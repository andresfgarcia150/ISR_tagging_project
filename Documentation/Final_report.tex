...
The \textit{matching} algorithm is presented in Fig. \colorbox{yellow}{TATATÁ}.
...
the detector interpretation. If the matched jet is too far from the ISR parton
or if it is a combination of several jets, the method does not reports any 
match.
